...
function Boards() {
  ...
  useEffect(() => {
    ...
    // Mỗi khi url thay đổi vd khi ta chuyển trang, thì location.search lấy từ hook useLocation của react-router-dom cx thay đổi theo, đồng nghĩa hàm useEffect sẽ chạy lại và fetch lại API theo đúng page mới vì location.search đã nằm trong dependencies của useEffect
  ...
  const afterCreateNewBoard = () => {
    // Fetch lai danh sach board tuong tu trong useEffect
    fetchBoardsAPI(location.search).then(updateStateData)
  }
