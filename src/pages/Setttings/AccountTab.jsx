...
function AccountTab() {
  ...
  const uploadAvatar = (e) => {
    ...
    // console.log('reqDatavvv: ', reqData.values())
    ...
    toast.promise(
      ...
      // Lưu ý, dù có lỗi hoặc thành công thì cx phải clear giá trị của file input, nếu không thì sẽ không thể chọn cùng 1 file liên tiếp được
      e.target.value = ''
    })
  }
