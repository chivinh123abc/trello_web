...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'RyanLuong MERN Stack Board',
        ...
        cards: [
          {
            ...
            title: 'Xin Xin So Cute',
            description: 'Markdown Syntax (sẽ ở khóa nâng cao nhé)',
            cover: 'https://i.pinimg.com/736x/d7/a6/0d/d7a60da66d05c6d2af9d887a6a73d4e8.jpg',
            memberIds: ['test-user-id-01'],
            comments: ['test comment 01', 'test comment 02'],
            attachments: ['test attachment 01', 'test attachment 02', 'test attachment 03']
          },
          { _id: 'card-id-02', boardId: 'board-id-01', columnId: 'column-id-01', title: 'Ryan Ding', description: null, cover: null, memberIds: [], comments: [], attachments: [] },
