...
function ActiveCard() {
  ...
  // Khong dung bien State de dong mo modal nua vi chung ta se check theo bien isShowModalActiveCard cua redux
  ...
  const callApiUpdateCard = async (updateData) => {
    ...
    // Cap nhat lai card dang active trong modal
    dispatch(updateCurrentActiveCard(updatedCard))
    // Cap nhat lai ban ghi card trong activeBoard (nested data)
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              {/* Neu user hien tai dang dang nhap chua thuoc mang memberIds cua card thi moi cho hien nut Join ra */}
              {/* Khi Click vao join thi luon la hanh dong ADD */}
